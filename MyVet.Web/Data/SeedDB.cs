...
namespace MyVet.Web.Data
{
    public class SeedDB
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Daniel", "Lemus", "danilemus55510@gmail.com", "320 700 5907", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Daniel", "Lemus", "daniel_lemus_z@hotmail.com", "320 700 5907", "Calle Luna Calle Sol", "Customer");
